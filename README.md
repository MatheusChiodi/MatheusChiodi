<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:FF5555,50:FF8C55,100:FF5555&height=180&section=header"/>
...
```javascript
const matheus = {
    role: "Development Analyst Front-end",
    company: "Move Mais TAG de Pedágio",
    location: "Brazil",
    
    expertise: ["React.js", "React Native", "Vue.js", "Angular", 
                "PHP", "CodeIgniter 3", "SQL", "Java"],
    
    achievements: {
        appsPublished: "7+ on Play Store",
